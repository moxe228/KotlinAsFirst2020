...
class Tests {
    ...
    fun mean() {
        ...
        assertEquals(-74797986907937570000.0, mean(listOf(-74797986907937570000.0)))
    }
    ...
    fun roman() {
        ...
        assertEquals("MMMCDXLVI", roman(3446))
    }
    ...
    fun russian() {
        ...
        assertEquals("сто две тысячи пятьсот восемь", russian(102508))
        ...
        assertEquals("восемнадцать тысяч семьсот шестнадцать", russian(18716))
        assertEquals("двести сорок тысяч двести тридцать девять", russian(240239))
    }
}